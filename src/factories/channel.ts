...
export function channelFactory(client: Client, channel: ChannelStructure | Partial<ChannelStructure>, resolved: boolean = false): Channel | PartialChannel | ResolvedChannel {
